...
const TOPICS = [
    "allintitle: DSC 0..9999 -sony",
    "allintitle: IMG 0..9999",
    "allintitle: 20000101..20303131 vid|mp4|mov|mkv|win",
    "allintitle: 1990..2022 01..31 jan|mar|apr|may|jun|jul|aug|sep|oct|nov|dec",
    "allintitle: 1990..2022 01..31 january|february|march|april|may|june|july|august|september|october|november|december",
    "\"coin collection\"|numismatics|\"coin show\"|\"coin collector\"|\"coin collecting\"",
    "\"fish farm\"|aquaculture|fisherie",
    "\"flat earth\"|chemtrails|\"hollow earth\"",
    "\"ghost sighting\"|paranormal|\"ghost hunting\"|haunted -phasmophobia",
    "\"google nest\"|\"nest camera\"|\"nest cam\"|\"wyze camera\"|\"wyze cam\"|\"ring camera\"|\"wyze cam\"|eufycam|\"arlo pro\" -review -unboxing -giveaway",
    "\"metal detecting\"|\"magnet fishing\"",
    "\"nature walk\"|\"state park\"|\"national park\"",
    "\"rock climbing\"|\"free solo\"|\"solo climbing\"",
    "abandoned|abandonded|derelict",
    "archaeology|\"achaeological dig\"|archaeologist|\"historical site\"",
    "avalanche|landslide|hurricane|tornado|tsunami|eruption|earthquake|wildfire",
    "boeing|airbus|embraer|bombardier|comac|aviastar|gippsaero|dassault|gulfstream|lockheed",
    "cat|kitten|kitty tabby|\"maine coon\"|\"american shorthair\"|birman|\"american shorthair\"|\"american shorthair\"|ragdoll -shorts -funny -amazon -sound -asmr",
    "caves|caving|potholing|spelunking|catacombs|\"natural cave\"|mineshaft|\"abandoned mine\" -minecraft",
    "cessna|beechcraft|mooney|pilatus|\"cirrus vision\"|embraer|learjet|stearman",
    "church|baptism|blessing|sermon|mosque|prayer|fellowship|worship|\"bible study\" -spotify -soundcloud -gaming",
    "disaster|crisis|conflict|scare",
    "dog|puppy labrador|terrier|\"golden retriever\"|\"german shepherd\"|malamute|dachshund|\"chihuahua\"|\"shih tzu\"|\"pit bull\"|mastiff -shorts -funny -amazon -sound -asmr",
    "drone|dji|yuneec|\"parrot anafi\"|autel|skydio|ehang",
    "expo|convention|fairground|\"state fair\"|\"county fair\"|festival|\"trade show\"|conference|\"trade fair\"",
    "exterminator|\"bug bomb\"|\"bee removal\"|\"wasp removal\"|\"hornet removal\"|infestation|\"pest control\"",
    "face reveal",
    "factory|industrial|manufacturing -music -song -xiaogotoy",
    "fishing|noodling|spearfishing|netting|angling|angler",
    "full stop punctuation",
    "funeral|cremation|\"scattering ashes\"|\"spreading ashes\"",
    "gopro|gopr",
    "gun|rifle|pistol|\"shooting range\"|\"machine gun\"|smg|lmg|grenade|c4|artillery|\"50 cal\"|shotgun|ak47 -gaming -cod -tarkov -\"call of duty\" -xbox -music -song -band",
    "gym|\"fitness center\"|workout|\"physical training\"|weightlifting|cardio",
    "helicopter bell|airbus|chinook|boeing|eurocopter|mil|robinson|sikorsky|\"black hawk\"|hughes -simulation",
    "hiking|trekking|\"appalachian trail\"|\"pennine way\"|\"continental divide trail\"|\"trail cam\"",
    "homicide|arson|manslaughter|burglary|\"child abduction\" -gta -games -gaming -song -music -beat -tune",
    "hunting|trapping|\"rabbit box\"|\"bear trap\"",
    "inn|hotel|motel|hampton|marriott|intercontinental|hilton|airbnb -basketball",
    "kayak|canoe|rafting|paddleboarding",
    "liquor|liqueur|beer|alcohol|brewery|distillery|winery|wine|whiskey|ipa|\"pale ale\"|vodka|tequila|cognac|gin|rum -music -song -jokes -funny",
    "marijuana|weed|cannabis|psilocybin|dispensary|indica|sativa -music -song -asmr",
    "meth|heroin|methamphetamine|cocaine|fentanyl|\"drugs seized\"|narcotics|overdose|opioid|narcan -song -band -track -beat -mixtape -soundcloud",
    "mine coal|gold|abandoned|tour|talc|silver|diamond|iron|uranium|anthracite|granite|shale|gem|acid|shaft|stope|cart -genesis -minecraft -raid -games -music",
    "pet exotic|snake|lizard|ant|bug|frog|gecko|cockroach|tarantula|spider|chameleon|parakeet|lovebird|cockatiel -funny -google -games",
    "police bodycam|\"body camera\"|arrest|\"traffic stop\"|dashcam|chase|investigation|helicopter",
    "railway|railroad|train|locomotive|metrorail",
    "repair|restoration|fixing board|appliance|solder|auto|car|truck|tractor|farm",
    "sailing|hallberg-rassy|\"nautor's swan\"|beneteau",
    "scuba|diving|submarine|snorkeling",
    "sighting|proof|encounter cryptid|vampire|sasquatch|mothman|chupacabra|\"loch ness monster\"|yeti",
    "skating|rollerblading|skateboarding|biking",
    "skiing|snowboarding|\"snow tubing\"|snowmobiling|snowmobile|bobsledding",
    "telescope|observatory|celestron|vaonis|\"sky-watcher\"|astrophotography|starsense|goscope|astroview",
    "ufo|\"flying saucer\"|uap|\"crop circle\"|extraterrestrial -gta -gtao -gtav",
    "vlog",
